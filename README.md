...
<h4> My Pick: 90Watt 19V DC Barrel Plug (5.5mm) (16$ USD) </h4>
...
<h4> My Pick: UPDATE: After recieving my hardware, I realize that despite the motherboard claiming ATX support, it needs a 19V 4 pin connection or barrel plug.  I attempted using a 12V 4 pin CPU connector and shorting ground pins on the 24 pin, but the system did not run. I ordered a very cheap 19V Power supply for 15$, but the largest wattage I could find for a barrel plug wall charger was 90Watts. this is very limiting. </h4>
